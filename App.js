...
const App = () => {
  ...
  const pageArr = [ //setiap obejk dalam pageArr mewakili satu halaman 
    { name: "Lots Of Styles", comp: <LotsOfStyles /> }, // comp digunakan untuk menyimpan komponen yang sesuai
    { name: "Fixed Dimensions Basics", comp: <FixedDimensionsBasics /> }, //name untuk menyimpan nama halamannya
